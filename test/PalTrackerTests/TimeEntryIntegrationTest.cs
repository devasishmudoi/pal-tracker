...
namespace PalTrackerTests
{
    ...
    public class TimeEntryIntegrationTest
    {
        ...
        public void Read()
        {
            var id = CreateTimeEntry(new TimeEntry(1, 999, 1010, new DateTime(2015, 10, 10), 9));
        ...
        public void Create()
        {
            var timeEntry = new TimeEntry(1, 222, 333, new DateTime(2008, 01, 08), 24);
        ...
        public void List()
        {
            var id1 = CreateTimeEntry(new TimeEntry(1, 222, 333, new DateTime(2008, 01, 08), 24));
            var id2 = CreateTimeEntry(new TimeEntry(2, 444, 555, new DateTime(2008, 02, 10), 6));
        ...
        public void Update()
        {
            var id = CreateTimeEntry(new TimeEntry(1, 222, 333, new DateTime(2008, 01, 08), 24));
